        ...
        loop {
            ...
            match &инструкция.вид {
                ...
                &ВидИнструкции::Обменять => {
                    ...
                    let первое = self.вытолкнуть_значение_цел()?;
                    let второе = self.вытолкнуть_значение_цел()?;
                    self.протолкнуть_значение_цел(первое)?;
                    self.протолкнуть_значение_цел(второе)?;
                    self.индекс_инструкции += 1;
                }
                &ВидИнструкции::Вытолкнуть => {
                    self.вытолкнуть_значение_цел()?;
                    self.индекс_инструкции += 1;
                }
