        ...
        loop {
            ...
            match &инструкция.вид {
                ...
                &ВидИнструкции::ГлобальныеДанные(смещение) => {
                    self.протолкнуть_значение_цел((self.начало_данных as i32 + смещение) as usize)?;
                    self.индекс_инструкции += 1;
                }
                ...
                ВидИнструкции::СкопироватьПамять => {
                    let размер = self.вытолкнуть_значение_цел()?;
                    let цель = self.вытолкнуть_значение_цел()?;
                    let источник = self.вытолкнуть_значение_цел()?;
                ...
                ВидИнструкции::БитИли => {
                    let а = self.вытолкнуть_значение_цел()?;
                    let б = self.вытолкнуть_значение_цел()?;
                    self.протолкнуть_значение_цел(а | б)?;
                    self.индекс_инструкции += 1;
                }
                ВидИнструкции::БитИ => {
                    let а = self.вытолкнуть_значение_цел()?;
                ...
                ВидИнструкции::БитСмещениеВлево => {
                    let сдвиг = self.вытолкнуть_значение_цел()?;
                    let значение = self.вытолкнуть_значение_цел()?;
                    self.протолкнуть_значение_цел(значение << сдвиг)?;
                    self.индекс_инструкции += 1;
                }
