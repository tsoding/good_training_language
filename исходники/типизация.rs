...
pub struct Структура {
    pub имя: Лексема,
    pub размер: usize,
    pub поля: ХэшТаблица<Строка, Поле>,
}
...
impl Тип {
    ...
    pub fn текст(&self) -> Строка {
        match self {
            Тип::Цел64 => "цел64".в_строку(),
            Тип::Нат8 => "нат8".в_строку(),
            Тип::Нат64 => "нат64".в_строку(),
            Тип::Вещ32 => "вещ32".в_строку(),
            Тип::Лог => "лог".в_строку(),
    ...
    pub fn размер(&self, структуры: &ХэшТаблица<Строка, Структура>) -> usize {
        match self {
            Тип::Нат8 => 1,
            Тип::Нат64 => 8,
            Тип::Цел64 => 8,
