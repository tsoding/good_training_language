    ...
    for инструкция in &пп.код {
        ...
        match &инструкция.вид {
            ...
            &ВидИнструкции::ЗаписатьКадр(_смещение) => {
                сделать!(&инструкция.лок, "кодогенерация инструкции ЗаписатьКадр");
                return Err(())
            }
            ...
            ВидИнструкции::ЦелБольше => {
                сделать!(&инструкция.лок, "кодогенерация инструкции ЦелБольше");
                return Err(())
            }
            ...
            ВидИнструкции::ЦелВычитание => {
                сделать!(&инструкция.лок, "кодогенерация инструкции ЦелВычитание");
                return Err(())
            }
            ВидИнструкции::ЦелУмножение => {
                сделать!(&инструкция.лок, "кодогенерация инструкции ЦелУмножение");
                return Err(())
            }
            ВидИнструкции::ЦелОстаток => {
                сделать!(&инструкция.лок, "кодогенерация инструкции ЦелОстаток");
                return Err(())
            }
            ВидИнструкции::ЦелДеление => {
                сделать!(&инструкция.лок, "кодогенерация инструкции ЦелДеление");
                return Err(())
            }
            ВидИнструкции::ЦелРавно => {
                сделать!(&инструкция.лок, "кодогенерация инструкции ЦелРавно");
                return Err(())
            }
