    ...
    for инструкция in &пп.код {
        ...
        match &инструкция.вид {
            ...
            ВидИнструкции::ВыделитьНаВторомСтеке(_размер) => {
                сделать!(&инструкция.лок, "Генерация инструкции {вид_инструкции:?} для эльф", вид_инструкции = инструкция.вид);
                return Err(());
            }
            ...
            ВидИнструкции::ВнешнийВызов{..} => {
                сделать!(&инструкция.лок, "Вызов внешних процедур в кодогенерации эльф");
                return Err(())
            }
            ...
            ВидИнструкции::Записать32 => {
                сделать!(&инструкция.лок, "Кодогенерация Записать32 для эльф");
                return Err(());
            }
            ...
            ВидИнструкции::Прочитать32 => {
                сделать!(&инструкция.лок, "Кодогенерация Прочитать32 для эльф");
                return Err(());
            }
            ...
            ВидИнструкции::Вещ32Деление => {
                сделать!(&инструкция.лок, "Кодогенерация инструкции Вещ32Деление для эльф");
                return Err(());
            }
            ...
            ВидИнструкции::БитИли => {
                сделать!(&инструкция.лок, "Кодогенерация БитИли для эльф");
                return Err(());
            }
