...
fn прочитать_содержимое_файла(путь_к_файлу: &Path, лок: Опция<Лок>) -> Результат<Vec<char>> {
...
const КОМАНДЫ: &[Команда] = &[
    Команда {
        ...
        запустить: |программа, mut аргы| {
            ...
            let содержимое: Vec<char> = прочитать_содержимое_файла(&файл_ввода, Нету)?;
    ...
    Команда {
        ...
        запустить: |программа, mut аргы| {
            ...
            let содержимое: Vec<char> = прочитать_содержимое_файла(&путь_к_файлу, Нету)?;
