            ...
            if let Some(процедура) = программа.имена.процедуры.get(процедура_точки_входа) {
                ...
                match цель {
                    Цель::ЛинуксИкс86_64Эльф => {
                        эльф::сгенерировать_исполняемый_файл(&путь_к_исполняемому, &программа.пп, процедура.точка_входа)?;
                    }
                    Цель::ЛинуксИкс86_64Фазм => {
                        фазм::сгенерировать_исполняемый_файл(&путь_к_исполняемому, &программа.пп, процедура.точка_входа)?;
                    }
                }
