            ...
            match вид {
                ...
                ВидБинопа::Либо => {
                    ...
                    match левый_тип {
                        ...
                        Тип::Лог => {
                            пп.код.push(Инструкция{ вид: ВидИнструкции::ЛогЛибо, лок: ключ.лок.clone() });
                        }
                        _ => {
                ...
                ВидБинопа::Как => {
                    ...
                    // СДЕЛАТЬ: конвертация из численных типов в логические должна преобразовывать все что != 0 в 1
                    // Иначе равенство не будет работать правильно.
                    match (&тип_значения, &тип_цели) {
                        (Тип::Нат64, Тип::Нат8) => Ok(тип_цели),
                        (Тип::Цел64, Тип::Нат8) => Ok(тип_цели),
                        (Тип::Нат64, Тип::Цел64) => Ok(тип_цели),
                        (Тип::Цел64, Тип::Нат64) => Ok(тип_цели),
                        (Тип::Нат8, Тип::Нат64) => Ok(тип_цели),
                        (Тип::Нат8, Тип::Цел64) => Ok(тип_цели),
                        (Тип::Цел64, Тип::Вещ32) => {
