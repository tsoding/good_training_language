...
pub struct ОбластьВидимости {
    pub переменные: ХэшТаблица<String, СкомпПеременная>,
    pub константы: ХэшТаблица<String, СкомпКонстанта>,
...
pub struct ПП {
    ...
    pub строки: ХэшТаблица<String, usize>,
    pub внешние_символы: ХэшТаблица<String, usize>,
    pub библиотеки: ХэшТаблица<String, usize>,
}
...
pub struct Имена {
    pub константы: ХэшТаблица<String, СкомпКонстанта>,
    pub процедуры: ХэшТаблица<String, СкомпПроцедура>,
    pub переменные: ХэшТаблица<String, СкомпПеременная>,
    pub структуры: ХэшТаблица<String, Структура>,
}
...
fn записать_тип(лок: &Лок, код: &mut Вектор<Инструкция>, структуры: &ХэшТаблица<String, Структура>, тип: &Тип) -> Результат<()> {
    if тип.примитивный() {
...
fn прочитать_примитивный_тип(лок: &Лок, код: &mut Вектор<Инструкция>, структуры: &ХэшТаблица<String, Структура>, тип: &Тип) -> Результат<()> {
        ...
        loop {
            ...
            match ключ.вид {
                ...
                ВидЛексемы::КлючСтрукт => {
                    ...
                    let mut поля: ХэшТаблица<String, Поле> = ХэшТаблица::new();
                    let mut размер = 0;
