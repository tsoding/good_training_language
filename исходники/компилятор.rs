...
pub enum ВидИнструкции {
    ...
    СисВызов{ номер: usize, арность: usize },
}
            ...
            match имя.текст.as_str() {
                    ...
                    for арг in аргументы {
                        ...
                        match тип {
                            ...
                            Тип::Цел64 => {
                                ...
                                пп.код.push(Инструкция { вид: ВидИнструкции::ВызватьПроцедуру(процедура.точка_входа), лок: арг.лок().clone() });
                ...
                _ => {
                    if let Some(процедура) = имена.процедуры.get(&имя.текст) {
                        ...
                        пп.код.push(Инструкция{ вид: ВидИнструкции::ВызватьПроцедуру(процедура.точка_входа), лок: имя.лок.clone() });
        ...
        loop {
            ...
            match ключ.вид {
                ...
                ВидЛексемы::КлючВкл => {
                    ...
                    let содержимое = ::прочитать_содержимое_файла(&путь_к_файлу)?;
