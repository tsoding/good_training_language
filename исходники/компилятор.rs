...
fn скомпилировать_утвержление(пп: &mut ПП, имена: &Имена, процедура: &СкомпПроцедура, утверждение: &Утверждение) -> Результат<()> {
    match утверждение {
        ...
        Утверждение::Если{ключ, условие, тело, иначе} => {
            ...
            for утверждение in тело.iter() {
                скомпилировать_утвержление(пп, имена, процедура, утверждение)?;
            }
        ...
        Утверждение::Вернуть{ключ, выражение} => {
            ...
            сделать!(&ключ.лок, "Безусловно прыгнуть в конец процедуры");
            Err(())
        }
    ...
    match процедура.тело {
        ТелоПроцедуры::Внутренее{блок} => {
            ...
            for утверждение in &блок {
                скомпилировать_утвержление(пп, имена, &скомп_процедура, утверждение)?;
            }
